...
A VCD waveform can be generated by the testbench and inspected using GTKWave.
...
The project focuses on practical RTL and computer architecture concepts:
...
- Pipeline flushing
- RTL verification
- Cycle-level performance characterization
...
A functional five-stage RV32I-subset processor with forwarding, load-use hazard handling, branch flushing, directed verification, and performance counters.
